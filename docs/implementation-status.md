...
Updated September 13, 2026. The character generator has been removed; creation starts from blank artwork. Tutorials are unchanged. This update was reviewed locally and approved for publication. Human usability research remains outstanding.
...
- Blank-canvas creation for original artwork; existing character projects remain editable, with legacy recipe-only import support.
...
- `tests/generator.test.cjs`: 23,040 legacy frames covering build/hair/outfit/hat/equipment/cape combinations remain pixel-exact against the captured legacy renderer.
...
- Browser interaction checks include create/draw/undo/redo, layers, frame duplication, save/reload/reopen, rectangular PNG import, resize/undo, malformed project rejection, selection cancel, guided lessons, legacy character import, clip playback, light/dark themes, and export preview/download invocation.
